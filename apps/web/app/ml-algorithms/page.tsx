      ...
      <div className="container mx-auto max-w-6xl">
        <header className="mb-8">
          <div className="flex items-center gap-3 mb-2 min-w-0">
            <Brain className="w-10 h-10 text-purple-500 shrink-0" />
            <h1 className="text-4xl font-bold min-w-0 break-words">Modern ML Algorithms</h1>
          </div>
          <p className="text-lg text-muted-foreground">
            Explore contrastive learning and advanced attention mechanisms
          </p>
          <div className="flex flex-wrap gap-2 mt-4">
            <Badge variant="outline">SimCLR</Badge>
            <Badge variant="outline">AliBI Attention</Badge>
          </div>
        </header>

        <Tabs defaultValue="simclr" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="simclr">
              <Zap className="w-4 h-4 mr-2" />
              SimCLR
            </TabsTrigger>
            <TabsTrigger value="alibi">
          ...
          <TabsContent value="simclr" className="space-y-6">
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>SimCLR Parameters</CardTitle>
                  <CardDescription>
                ...
                <CardContent className="space-y-6">
                  ...
                  {/* Embedding Dimension */}
                  <div className="space-y-2">
                    <Label htmlFor="embedding-dim">Embedding Dimension: {embeddingDim}</Label>
                    <Slider
                      id="embedding-dim"
                      min={4}
                      max={32}
                  ...
                  <Button onClick={runSimCLR} className="w-full" size="lg">
                    Compute Contrastive Loss
                  </Button>

                  {contrastiveResult && (
                    <div className="p-4 bg-gradient-to-br from-purple-950/40 to-purple-900/40 border border-purple-500/40 rounded-lg">
                      <div className="font-semibold text-purple-300 mb-2">Loss Value</div>
            ...
            <Card>
              <CardHeader>
                <CardTitle>About SimCLR</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-sm text-muted-foreground">
                ...
                <div className="overflow-x-auto">
                  <p className="font-mono text-xs bg-background/50 p-2 rounded whitespace-nowrap">
          ...
          <TabsContent value="alibi" className="space-y-6">
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>AliBI Parameters</CardTitle>
                  <CardDescription>
                ...
                <CardContent className="space-y-6">
                  {/* Sequence Length */}
                  <div className="space-y-2">
                    <Label htmlFor="seq-length">Sequence Length: {seqLength}</Label>
                    <Slider
                      id="seq-length"
                      min={4}
                      max={32}
                  ...
                  {/* Number of Heads */}
                  <div className="space-y-2">
                    <Label htmlFor="num-heads">Number of Heads: {numHeads}</Label>
                    <Slider
                      id="num-heads"
                      min={1}
                      max={8}
                  ...
                  <Button onClick={runAliBI} className="w-full" size="lg">
                    Compute Attention
                  </Button>

                  {attentionResult && (
                    <div className="space-y-3">
                      <div className="p-4 bg-gradient-to-br from-blue-950/40 to-blue-900/40 border border-blue-500/40 rounded-lg">
                        <div className="font-semibold text-blue-300 mb-2">Attention Statistics</div>
            ...
            <Card>
              <CardHeader>
                <CardTitle>About AliBI</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3 text-sm text-muted-foreground">
                <p>
        ...
        <section className="mt-12 space-y-6">
          <h2 className="text-2xl font-semibold">Modern ML Innovations</h2>

          <div className="grid gap-6 md:grid-cols-2">
            <div className="group relative p-6 rounded-lg bg-gradient-to-br from-purple-950/40 to-purple-900/40 border border-purple-500/40 hover:border-purple-400/70 transition-all duration-300 overflow-hidden">
              <h3 className="text-lg font-semibold mb-2 text-purple-300 min-w-0 break-words">Contrastive Learning</h3>
            ...
            <div className="group relative p-6 rounded-lg bg-gradient-to-br from-blue-950/40 to-blue-900/40 border border-blue-500/40 hover:border-blue-400/70 transition-all duration-300 overflow-hidden">
              <h3 className="text-lg font-semibold mb-2 text-blue-300 min-w-0 break-words">Efficient Transformers</h3>
            ...
            <div className="group relative p-6 rounded-lg bg-gradient-to-br from-emerald-950/40 to-emerald-900/40 border border-emerald-500/40 hover:border-emerald-400/70 transition-all duration-300 overflow-hidden">
              <h3 className="text-lg font-semibold mb-2 text-emerald-300 min-w-0 break-words">Applications</h3>
            ...
            <div className="group relative p-6 rounded-lg bg-gradient-to-br from-rose-950/40 to-rose-900/40 border border-rose-500/40 hover:border-rose-400/70 transition-all duration-300 overflow-hidden">
              <h3 className="text-lg font-semibold mb-2 text-rose-300 min-w-0 break-words">Why It Matters</h3>
