...
export type ForumPostQuery = { forumPost: { id: string, title: string, content: string, tags: Array<string>, views: number, isPinned: boolean, isClosed: boolean, createdAt: string, updatedAt: string, commentCount: number, upvoteCount: number, hasUpvoted: boolean, user: (
      { bio: string | null, role: UserRole, createdAt: string }
      & { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }
    ), comments: Array<{ id: string, content: string, createdAt: string, upvoteCount: number, hasUpvoted: boolean, user: { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }, parent: { id: string } | null, replies: Array<{ id: string, content: string, createdAt: string, upvoteCount: number, hasUpvoted: boolean, user: { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } } }> }> } | null };
...
export type CreateForumPostMutation = { createForumPost: { id: string, title: string, content: string, tags: Array<string>, views: number, isPinned: boolean, isClosed: boolean, createdAt: string, upvoteCount: number, hasUpvoted: boolean, user: { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } } } };
...
export type CreateCommentMutation = { createComment: { id: string, content: string, createdAt: string, upvoteCount: number, hasUpvoted: boolean, user: { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }, parent: { id: string } | null, replies: Array<{ id: string }> } };
...
export type UserSummaryFragment = { id: string, name: string | null, image: string | null } & { ' $fragmentName'?: 'UserSummaryFragment' };

export type PublicUserSummaryFragment = { id: string, name: string | null, image: string | null } & { ' $fragmentName'?: 'PublicUserSummaryFragment' };
...
export type MeQuery = { me: (
    { email: string, bio: string | null, role: UserRole, createdAt: string, updatedAt: string, worksheetCount: number }
    & { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }
  ) | null };
...
export type WorksheetsQuery = { worksheets: { nodes: Array<{ id: string, title: string, description: string | null, visibility: WorksheetVisibility, views: number, createdAt: string, updatedAt: string, user: { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } }, folder: { id: string, name: string } | null }>, pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean, totalCount: number, currentPage: number, totalPages: number } } };
...
export type PublicWorksheetsQuery = { publicWorksheets: { nodes: Array<{ id: string, title: string, description: string | null, views: number, createdAt: string, user: { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } } }>, pageInfo: { hasNextPage: boolean, totalCount: number, currentPage: number, totalPages: number } } };

export type GpuLabWorksheetsQueryVariables = Exact<{
  limit?: number | null | undefined;
  offset?: number | null | undefined;
}>;


export type GpuLabWorksheetsQuery = { publicWorksheets: { nodes: Array<{ id: string, title: string, description: string | null, views: number, updatedAt: string, content: Record<string, unknown>, user: { ' $fragmentRefs'?: { 'UserSummaryFragment': UserSummaryFragment } } }>, pageInfo: { totalCount: number } } };
...
export type SharedCalculationQuery = { sharedCalculation: { id: string, shortCode: string, latex: string, expression: string, title: string | null, description: string | null, result: string | null, createdAt: string, expiresAt: string | null, user: { ' $fragmentRefs'?: { 'PublicUserSummaryFragment': PublicUserSummaryFragment } } | null } | null };
...
export type WorksheetSyncQueryVariables = Exact<{
  worksheetId: string | number;
}>;


export type WorksheetSyncQuery = { worksheet: { id: string, title: string, content: Record<string, unknown>, updatedAt: string } | null };

export type WorksheetUpdatedSubscriptionVariables = Exact<{
  worksheetId: string | number;
}>;


export type WorksheetUpdatedSubscription = { worksheetUpdated: { id: string, title: string, content: Record<string, unknown>, version: number, updatedAt: string } };
...
export const PublicUserSummaryFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PublicUserSummary"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"PublicUser"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"image"}}]}}]} as unknown as DocumentNode<PublicUserSummaryFragment, unknown>;
...
export const MeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Me"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"me"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"UserSummary"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"bio"}},{"kind":"Field","name":{"kind":"Name","value":"role"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"worksheetCount"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"UserSummary"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"image"}}]}}]} as unknown as DocumentNode<MeQuery, MeQueryVariables>;
...
export const WorksheetSyncDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"WorksheetSync"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"worksheetId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"worksheet"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"worksheetId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<WorksheetSyncQuery, WorksheetSyncQueryVariables>;
export const WorksheetUpdatedDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"WorksheetUpdated"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"worksheetId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"worksheetUpdated"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"worksheetId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"worksheetId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"content"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<WorksheetUpdatedSubscription, WorksheetUpdatedSubscriptionVariables>;