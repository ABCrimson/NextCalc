...
As of 2026-08-27, the live wiki reflects **v1.5.2 plus the 2026-08-27 accuracy refresh** (stack versions after the evergreen bump: Next 16.4 canary, TS 7.1-dev on all 10 packages, Prisma 8.1 dev, pnpm 12, Vitest 5 RC), synced via the wiki-repo commit `wiki: sync from docs/wiki (2026-08-27)`. `Home.md`, `_Footer.md`, and `_Sidebar.md` all display "v1.5.2".
